...
//            Toast.makeText(AppApplication.getAppContext(), "发卡机串口打开成功", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
//            Toast.makeText(AppApplication.getAppContext(), "发卡机串口打开失败", Toast.LENGTH_SHORT).show();
        }
    }
