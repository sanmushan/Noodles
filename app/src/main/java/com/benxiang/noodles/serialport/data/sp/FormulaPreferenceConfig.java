...
public class FormulaPreferenceConfig {
    ...
    public static void setTypeCHeatSize(String typeCHeatSize) {
    ...
    public static int getTwoPliesMax() {
        return PreferenceNoodlesUtil.config().getInt(PreferenceKey.TWO_PLIES_MAX, DbTypeContants.JIUI_PLIE_NO);
    }
    ...
    public static int getThreePliesMax() {
        return PreferenceNoodlesUtil.config().getInt(PreferenceKey.THREE_PLIES_MAX, DbTypeContants.LUDAN_PLIE_NO);
    }
    ...
    public static int getFourPliesMax() {
        return PreferenceNoodlesUtil.config().getInt(PreferenceKey.FOUR_PLIES_MAX, DbTypeContants.LUDAN_PLIE_NO);
    }
...
//    }
    ...
    public static int getFirstPrizeCategory() {
        return PreferenceNoodlesUtil.config().getInt(PreferenceKey.FIRST_PRIZE_CATEGORY,DbTypeContants.SUANLAJITUI);
    }
    ...
    public static int getSecondPrizeCategory() {
        return PreferenceNoodlesUtil.config().getInt(PreferenceKey.SECOND_PRIZE_CATEGORY,DbTypeContants.LUJIDANG);
    }
