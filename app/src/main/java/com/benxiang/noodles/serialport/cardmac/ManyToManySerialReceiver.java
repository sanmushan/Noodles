...
//                    if (errorCode==56 || errorCode==58 || errorCode==59){
//                        int occurErrorCount = FormulaPreferenceConfig.getErrorCount();
//                        if (occurErrorCount> PreferenceKey.ERROR_COUNT_AllOW){
//                            logReceive("加汤没完成,mExecStep="+ mExecStep);
//                            mOnFailureListener.addSoup(errorCode);
//                        }else {
//                            if (ByteUtil.isByteEqual(specialCode,(byte) 0x01)||ByteUtil.isByteEqual(specialCode,(byte) 0x03)){
//                                FormulaPreferenceConfig.setErrorCount(occurErrorCount+1);
//                            }
//                            logReceive("水或料不足，加汤完成,mExecStep="+ mExecStep+",occurErrorCount="+occurErrorCount);
//                            mOnSuccessListener.addSoup();
//                        }
//                    }else {
//                        logReceive("加汤没完成,mExecStep="+ mExecStep);
...
//                                FormulaPreferenceConfig.setErrorCount(occurErrorCount+1);
//                            }
//                            logReceive("启动加热,mExecStep="+ mExecStep+",occurErrorCount="+occurErrorCount);
//                            mOnSuccessListener.startHeat();
//                        }
//                    }else {
//                        logReceive("启动加热没完成,mExecStep="+ mExecStep);
...
//                                FormulaPreferenceConfig.setErrorCount(occurErrorCount+1);
//                            }
//                            logReceive("循环启动加热,mExecStep="+ mExecStep+",occurErrorCount="+occurErrorCount);
//                            mOnSuccessListener.recycleStartHeat();
//                        }
//                    }else {
//                        logReceive("循环启动加热没完成,mExecStep="+ mExecStep);
