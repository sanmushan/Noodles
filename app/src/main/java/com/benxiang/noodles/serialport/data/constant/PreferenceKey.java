...
//    public static int TYPE_A_WATER_DEFAULT = 60;
//    public static int TYPE_B_WATER_DEFAULT = 60;
//    public static int TYPE_C_WATER_DEFAULT = 69;
////    public static int TYPE_A_HEAT_DEFAULT = 200;
////    public static int TYPE_B_HEAT_DEFAULT = 200;
////    public static int TYPE_C_HEAT_DEFAULT = 90;
//
...
//    public static int BRINE_DEFAULT = 23;
//    public static int VINEGAR_DEFAULT = 60;
//    public static int HEAT_SIZE_DEFAULT = 150;
////
//    public static int BRINE_A_DEFAULT = 25;

    public static int TYPE_A_WATER_DEFAULT = 80;
    public static int TYPE_B_WATER_DEFAULT = 80;
    public static int TYPE_C_WATER_DEFAULT = 80;
    ...
    public static int OIL_DEFAULT = 70;
    public static int BRINE_DEFAULT = 30;//卤水
    public static int VINEGAR_DEFAULT = 45;//醋
    public static int HEAT_SIZE_DEFAULT = 150;
//
    public static int BRINE_A_DEFAULT = 25;

//    public static int TYPE_A_WATER_DEFAULT = 0;
//    public static int TYPE_B_WATER_DEFAULT = 0;
//    public static int TYPE_C_WATER_DEFAULT = 0;
//
//    public static int TYPE_A_HEAT_DEFAULT = 150;
//    public static int TYPE_B_HEAT_DEFAULT = 150;
//    public static int TYPE_C_HEAT_DEFAULT = 150;
//
//    public static int OIL_DEFAULT = 0;
//    public static int BRINE_DEFAULT = 0;//卤水
//    public static int VINEGAR_DEFAULT = 0;//醋
//    public static int HEAT_SIZE_DEFAULT = 150;
////
//    public static int BRINE_A_DEFAULT = 0;
