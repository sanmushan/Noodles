...
//    public void setTypeNoodles(NoodlesType noodleType){
//        mNumberNoodles = CalNoodlesNum.getNumberNoodlesMin(noodleType);
//    }
    ...
    public void sendToDoor() {
        ...
        if (mRepeatTimes > 0){
            ...
            if ((arrLength-1) == mIndexHeat){
                ...
                sendSerialData(soupOrHeatCommand);
//                if(arrLength == 3){
//                    byte[] soupOrHeatCommand = CalNoodlesNum.getSoupOrHeatCommand(mNumberNoodlesArr[2]);//2
//                    sendSerialData(soupOrHeatCommand);
//                }else if(mNumberNoodlesArr.length >= 4){
//                    byte[] soupOrHeatCommand = CalNoodlesNum.getSoupOrHeatCommand(mNumberNoodlesArr[2],mNumberNoodlesArr[3]);//2,3
//                    sendSerialData(soupOrHeatCommand);
//                }
            }
        }else {
...
//            if(mNumberNoodlesArr.length == 2){
//                byte[] soupOrHeatCommand = CalNoodlesNum.getSoupOrHeatCommand(mNumberNoodlesArr[1]);
//                sendSerialData(soupOrHeatCommand);
//            }else if(mNumberNoodlesArr.length >= 3){
//                byte[] soupOrHeatCommand = CalNoodlesNum.getSoupOrHeatCommand(mNumberNoodlesArr[1],mNumberNoodlesArr[2]);
//                sendSerialData(soupOrHeatCommand);
//            }
//
//        }else {
//            mNoodlesSerialReceiver.setExecStep(18);
//            sendSerialData(NoodlesSerialCommand.SEND_TO_DOOR);
//        }
    }
...
//                sendSerialData1(NoodlesSerialCommand.CHOICE_NOODLES);
            ...
            public void sendToSoupArea() {
                logStep("送到加汤区完成");
//                byte[] soupOrHeatCommand = CalNoodlesNum.getSoupOrHeatCommand(mNumberNoodlesArr[0]);
