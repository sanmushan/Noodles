...
//    public void setNumberNoodles(List<Integer> numberNoodlesArr){
//        mNumberNoodlesArr = CalNoodlesNum.arrayListToArr(numberNoodlesArr);
//        //后缀重复部分要执行的次数
...
//    }
    ...
    //获取做面的数据，重置变量
    public void setNoodleEventDatas(){//List<RiceOrderND> noodleEventDataArr
//        mNoodleEventDataArr = noodleEventDataArr;

//        mNoodleEventDataArr = DBNoodleHelper.queryWithoutNoodle(0);
        if (mNoodleEventDataArr.size() == 0){
            Timber.e("没有要做的面,轮询检测");
//            currentThreadSleep(10*1000);
//            setNoodleEventDatas();
            return;
        }
...
//    public void addNoodleEventDatas(List<RiceOrderND> noodleEventDataArr){
//        for (int i=0; i<noodleEventDataArr.size(); i++){
//            mNoodleEventDataArr.add(noodleEventDataArr.get(i));
//        }
//        mNumberNoodlesArr = CalNoodlesNum.getNoodleNos(mNoodleEventDataArr);
//        mNoodleStateArr = CalNoodlesNum.getNoodleStates(mNoodleEventDataArr);
//
//        mRepeatTimes += noodleEventDataArr.size();
////        mIndexHeat = 1;   //不改
////        mIndexRepeatChoice =3;    //不改
////        mIndexFinishNumberNoodles=0;  //不改
//    }

    public void addNoodleEventDatas(int indexNumberNoodles){//,List<NoodleEventData> lists
        List<RiceOrderND> newAddNoodleEventDataArr = DBNoodleHelper.queryWithoutNoodle(Constants.SIGN_NOT_DO);
//        newAddNoodleEventDataArr.removeAll(null);

//        RiceOrderND riceOrderND = new RiceOrderND();
//        riceOrderND.noodleNo = 5;
//        riceOrderND.noodleState = NoodleNameConstants.SUANLA;
//        newAddNoodleEventDataArr.add(riceOrderND);
//
//        RiceOrderND riceOrderND2 = new RiceOrderND();
//        riceOrderND2.noodleNo = 16;
//        riceOrderND2.noodleState = NoodleNameConstants.HAOHUA;
//        newAddNoodleEventDataArr.add(riceOrderND2);
