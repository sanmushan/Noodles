...
//    private void startcompelet() {
//        getMainHandler().postDelayed(new Runnable() {
//            @Override
//            public void run() {
//                Intent intent = new Intent(NoodlesMakeActivity.this, NoodlesCompeletActivity.class);
//                Bundle bundle = new Bundle();
////                bundle.putParcelable("listModle", listModles);
...
//        getnumberList(DbTypeContants.MIFEN);
//        getnumberList(DbTypeContants.MIANTIAO);
        getnumberList();
    }
...
//                retreaFood();
    ...
    //退菜
//    private void retreaFood() {
//        List<ListModle> unDoneList = getUnDoneList();
//        RetreatFoodParam retreatFoodParam = ParamObtainUtil.getRetreadFood(noodleTradeModel, unDoneList);
//        mUploadExPresenter.retreatFood(MethodConstants.BACKORDERITEM, JsonHelper.getGson().toJson(retreatFoodParam));
//    }
