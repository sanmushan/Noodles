...
public abstract class BaseActivity extends BaseRefundAct implements UplaodExView {
    ...
    //退款==》一单一单退
//    private String take_meal_No;
//    private boolean isSetBillStatusByTakeNumber;
...
//        take_meal_No = unDoneList.get(0).take_meal_No;
//        isSetBillStatusByTakeNumber = unDoneList.get(0).isSetBillStatusByTakeNumber;
...
//        NoodleDataUtil.addRiceDbMany(riceOrderNDs);
        //删除这一单
