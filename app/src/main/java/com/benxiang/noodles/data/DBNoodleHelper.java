...
//    public static void upateNoodleSign(int noodleNo,int noodleSign) {
//        ColumnsValue columnsValue = new ColumnsValue(new String[]{RiceOrderND.COL_RICE_SIGN}, new Object[]{noodleSign});
//        getmDBNoodle().update(WhereBuilder.create(RiceOrderND.class).equals(RiceOrderND.COL_RICE_ND, noodleNo),columnsValue,ConflictAlgorithm.None);
//    }

//    public static void upateNoodleSign(int noodleNo,int noodleSign) {
//        RiceOrderND riceOrderND = queryWithoutNoodle(noodleSign).get(0);
//        ColumnsValue columnsValue = new ColumnsValue(new String[]{RiceOrderND.COL_RICE_SIGN}, new Object[]{noodleSign});
//        getmDBNoodle().update(WhereBuilder.create(RiceOrderND.class).equals(RiceOrderND.COL_ID, riceOrderND.id)
//                .equals(RiceOrderND.COL_RICE_ND, noodleNo)
