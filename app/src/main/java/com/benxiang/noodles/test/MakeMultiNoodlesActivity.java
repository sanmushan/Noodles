...
//import com.benxiang.noodles.base.BaseSerialActivity;
...
//                @Override
//                protected void onFinish(int numberNoodle) {
//                    makeToast("制作"+numberNoodle+"米粉完成,请取粉");
//                    //开始倒计时，开始检测取料箱是否为空
//                    Timber.e("制作"+numberNoodle+"米粉完成,请取粉");
//                    setEnableCountdown(true,5);
//                    startDownTime();
//                    initRecycleNoodles();
//                    mRecycleNoodlesUtil.startCheckBox();
...
//        list.add(NoodlesType.TYPE_B);
//        mMakeNoodlesUtil.setTypeNoodles(list);

//        ArrayList<Integer> list = new ArrayList<Integer>();
//        list.add(3);
//        list.add(4);
//        mMakeNoodlesUtil.setNumberNoodles(list);
...
//        NoodleEventData noodleEventData3 = new NoodleEventData();
//        noodleEventData3.noodle_no = 25;
//        noodleEventData3.noodle_state = NoodleNameConstants.CHONGQING;
//        list.add(noodleEventData3);
//
//        NoodleEventData noodleEventData4 = new NoodleEventData();
//        noodleEventData4.noodle_no = 25;
//        noodleEventData4.noodle_state = NoodleNameConstants.CHONGQING;
//        list.add(noodleEventData4);
//
//        NoodleEventData noodleEventData5 = new NoodleEventData();
//        noodleEventData5.noodle_no = 25;
//        noodleEventData5.noodle_state = NoodleNameConstants.CHONGQING;
//        list.add(noodleEventData5);
...
//        Timber.e("makeOrRecycleNoodles的值:"+comRecData.makeOrRecycleNoodles+","+ MyFunc.ByteArrToHex(comRecData.bRec));
